...
* 作为商品难免会有品控问题，若不幸发现购买到的商品有问题，可以直接找京东自营店家换新（新买的电脑在确定没有问题之前不要联网！)  
...
* 可以运行大部分专业所需软件。对性能没有很高要求、而自己经常需要随身携带笔记本电脑的情况下，你可以使用低性能笔记本。  
...
3. 规避宿舍对大功率设备的限制:在不超过功率限制的情况下获得相对优秀的性能，为需要高性能移动办公提供了解决方案。
